...
* @nivibilla's [adapation](https://github.com/nivibilla/efficient-vits-finetuning)https://github.com/nivibilla/efficient-vits-finetuning of HifiGan's discriminator for English VITS
